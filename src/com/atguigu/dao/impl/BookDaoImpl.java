...
public class BookDaoImpl extends BaseDao implements BookDao {
    ...
    public List<Book> queryBooks() {
        ...
        return queryForLise(Book.class,sql);
    }
    ...
    public List<Book> queryForPageItems(int begin, int pageSize) {
        ...
        return queryForLise(Book.class,sql,begin,pageSize);
    }
    ...
    public List<Book> queryForPageItemsByPrice(int begin, int pageSize, int min, int max) {
        String sql = "select `id`,`name`,`author`,`price`,`sales`,`stock`," +
                "`img_path` as imgPath from t_book " +
                "where price between ? and ? order by price limit ?,?";
        return queryForLise(Book.class,sql,min,max,begin,pageSize);
    }
}
