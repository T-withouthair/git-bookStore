...
<body text=#000000 bgColor="#ffffff" leftMargin=0 topMargin=4>
	...
	<script language="javascript">
		...
		function GetDateNow() {
			...
			<%--document.getElementById("WIDout_trade_no").value =  ${sessionScope.orderId};--%>
			document.getElementById("WIDsubject").value = "书籍";
			document.getElementById("WIDtotal_amount").value = ${sessionScope.cart.totalPrice};

			// 存储
			var value = sessionStorage.setItem("sNow",sNow);
		}
		GetDateNow();
